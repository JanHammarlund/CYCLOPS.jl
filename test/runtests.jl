...
#             m_CheckCyclopsConstructorInput = methods(CheckCyclopsConstructorInput);
#             @test length(methods(CheckCyclopsConstructorInput)) == 1   # 1
#             @test any(m_CheckCyclopsConstructorInput -> m_CheckCyclopsConstructorInput.sig == Tuple{typeof(CheckCyclopsConstructorInput), Int64, Int64, Int64}, m_CheckCyclopsConstructorInput)

#             # c < 2 error, 4 tests
#             @testset "invalid c" begin
#                 @test_throws CyclopsHypersphereDimensionError CheckCyclopsConstructorInput(5,0,1)  # 1
#                 @test_throws "`c` = 1, but `c` must be ≥ 2." CheckCyclopsConstructorInput(5,0,1)   # 2
...
#                 @test_throws CyclopsInputHypersphereDimensionError CheckCyclopsConstructorInput(2,0,2) # 1
#                 @test_throws "`n` = 2 ≤ `c`, but `n` must be > 2." CheckCyclopsConstructorInput(2,0,2) # 2
...
#                 @test_throws CyclopsMultiHotDimensionError CheckCyclopsConstructorInput(5,-1,2)        # 1
#                 @test_throws "`m` = -1 < 0, but `m` must be ≥ 0." CheckCyclopsConstructorInput(5,-1,2) # 2
...
#                 @test_throws MethodError CheckCyclopsConstructorInput(5f0,0,2) # 1
#                 @test_throws MethodError CheckCyclopsConstructorInput(5,0f0,2) # 2
#                 @test_throws MethodError CheckCyclopsConstructorInput(5,0,2f0) # 3
...
#             @test any(m_CheckCyclopsInput -> m_CheckCyclopsInput.sig == Tuple{typeof(CheckCyclopsInput), Vector{Float32}, Vector{Int32}, Array{Float32}}, m_CheckCyclopsInput)
...
#                     @test_throws CyclopsInputMultiHotDimensionMismatch CheckCyclopsInput(ones(Float32, 6), Int32.([1, 0, 1]), test_cyclops.scale) # 2
#                     @test_throws "Input = 6 ≠ 5 = Multi-hot Parameters" CheckCyclopsInput(ones(Float32, 6), Int32.([1, 0, 1]), test_cyclops.scale)    # 3
...
#                     @test_throws CyclopsMultiHotParameterDimensionMismatch CheckCyclopsInput(ones(Float32, 5), Int32.([1, 0]), test_cyclops.scale) # 2
#                     @test_throws "Multi-hot encoding = 2 ≠ 3 = Multi-hot Parameters" CheckCyclopsInput(ones(Float32, 5), Int32.([1, 0]), test_cyclops.scale)  # 3
...
#                 @test CheckCyclopsInput(x, h, test_cyclops.scale) isa Nothing # 1
